...
<title>Sikkerhetsrapport – ${dato}</title>
<style>
...
<nav class="sidemeny">
  <div class="sidemeny-header">
    ...
    <h1>Sikkerhetsrapport <span>${dato}</span></h1>
  </div>
...
<div class="hoveddel">
  <div class="rapport-header">
    <div>
      ...
      <div class="meta"><a href="${START_URL}" target="_blank">${START_URL}</a> · ${dato} · ${varighet}s</div>
    </div>
  ...
  <footer>KS Tilskudd · Sikkerhetstester · Playwright · ${dato}</footer>
</div>
</body>
</html>`;
